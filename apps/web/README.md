...
decisions, see the root [README.md](../../README.md), [stack.md](../../stack.md) and
...
- `lib/offramp.ts` — **exit-adapter** interface (card / CCTP), outside the trust boundary, recipient-signed (Tyler #3/#4); surfaced in the UI as a disabled placeholder only (SOW scope)
